...
#from funlog.portlet.latest import LatestPublishMessageFactory as _


class ILatestPublish(IPortletDataProvider):
    """A portlet
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('latestpublish.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(ILatestPublish)
